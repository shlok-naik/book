...
enum SoftPillBackdrop {
  /// A plain scaffold, colored [AppColors.background].
  background,

  /// A raised card or sheet, colored [AppColors.surface] — the paywall
  /// card and the settings email sheet both sit here.
  surface,
}
